...
function Keen2(props) {
  ...
  if (props.active === props.id) return <group onClick={() => props.test(props.change)} position={props.position} rotation={[-Math.PI / 2, 0, 0]} dispose={null}>
    <mesh material={materials["Scene_-_Root"]} geometry={nodes.mesh_0.geometry} castShadow receiveShadow />
  </group>
  return (
    <>
